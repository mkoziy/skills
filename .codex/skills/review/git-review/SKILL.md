...
```bash
python3 ~/.codex/skills/review/git-review/scripts/git-review.py [base_ref]
```
...
1. Script generates a cleaned-up diff (friendly headers, no technical noise)
...
Analyze annotations and design the fix approach:
