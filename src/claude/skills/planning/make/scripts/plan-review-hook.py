...
requirements:
  ...
  - revdiff path: tmux, zellij, kitty, wezterm, kaku, cmux, ghostty,
    iTerm2, or emacs vterm
...
def main() -> None:
    ...
    # use CLAUDE_PLUGIN_ROOT if set (plugin install), otherwise fall back to
    # the parent of this script's directory (standalone skills install)
