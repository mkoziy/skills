...
Run: `bash ${CLAUDE_PLUGIN_ROOT}/scripts/run-codex.sh "<prompt>"` with `run_in_background: true`. You will be notified when done — do NOT poll or sleep.
