...
Invoke directly with `/brainstorm` or let it activate via intent matching.
...
User: "brainstorm — add my Go rules to brainstorm rules"
→ asks what rules to add, writes to ~/.claude/brainstorm-rules.md
```
